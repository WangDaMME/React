/**
 * 作用：路径 /quiz3 的页面
 * - 文件位置 app/quiz3/page.tsx → URL /quiz3
 * - Server Component：在服务端 async 拉取评论（listComments），不经过浏览器请求；有 props 时和普通 React 一样在参数里接
 * - dynamic = 'force-dynamic' 表示每次请求都重新拉数据，不用缓存
 */
