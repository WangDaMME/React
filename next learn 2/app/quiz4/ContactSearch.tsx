/**
 * 作用：Client Component（'use client'）— 联系人搜索
 * - 数据在浏览器里通过 fetch('/api/quiz4/query_baseline' | 'query_optimized') 获取，结果存 useState，无 Redux
 * - 与 Server 无关：列表数据不来自 Server Component props，完全由本组件调 API 后自己渲染
 */
'use client'
